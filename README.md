...
- **[ECS vs EKS vs Lambda Architecture](./systems/aws-multi-compute-pci-payments-platform/)**: ECS, EKS, Lambda compared behind weighted ALB with ECR scan gate and 10% canary blue/green
